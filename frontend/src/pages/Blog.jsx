    ...
    <div className='relative'>
      ...
      <Navbar/>
       ...
       <div className='text-center mt-20 text-gray-600'>
        ...
        border-primary/35 b-primary/5 font-medium text-primary'>Akshansh Lohan</p>
       </div>
       ...
       <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='max-w-3xl mx-auto'>
            ...
            max-w-lg'>
              ...
              <textarea onChange={(e)=> setName(e.target.value)} value={content} placeholder='Comment' className='w-full p-2 border
